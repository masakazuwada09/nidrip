...
<html lang="en">
    <head>
        ...
        <title>View Orders | <?php echo $company_name; ?></title>
            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <?php include($AaliLINK_IN."/functions/HTML/order-box.php"); ?>
                        <?php include($AaliLINK_IN."/functions/HTML/order-table.php"); ?>
                    </section>
                </div>
